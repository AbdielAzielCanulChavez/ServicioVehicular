...
public class RegisterActivity extends AppCompatActivity {
    ...
    TextInputEditText mTextInputConfir;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       mDialog = new SpotsDialog.Builder().setContext(RegisterActivity.this).setMessage("Espere un momento").build();
        ...
        mTextInputConfir = findViewById(R.id.textInputPasswordConfirmar);
    ...
    void clickRegister() {
        ...
        final String confirmarPass = mTextInputConfir.getText().toString();

        if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty() && !confirmarPass.isEmpty()) {
           if(password.equals(confirmarPass)) {
               ...
               Toast.makeText(RegisterActivity.this, "Las contrasenias no coinciden", Toast.LENGTH_SHORT).show();
