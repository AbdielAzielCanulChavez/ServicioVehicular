...
public class RegisterDriverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextInputConfirm = findViewById(R.id.textInputPasswordConfirm);
    ...
    void clickRegister() {
        ...
        final String confirmPass = mTextInputConfirm.getText().toString();

        if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty() && !vehicleBrand.isEmpty() && !vehiclePlate.isEmpty() && !confirmPass.isEmpty()) {
           if(password.equals(confirmPass)) {
               ...
               Toast.makeText(RegisterDriverActivity.this, "Las contrasenias no coinciden", Toast.LENGTH_SHORT).show();
           }
        }
        else {
